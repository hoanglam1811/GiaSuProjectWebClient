...
export function Register({ token, setOTPSend, setSignIn, setSignUpCompleted, setSignUpCompletedMessage }) {
    ...
    const validateUserInfo = () => {
        ...
        if (password.length < 3) {
            setErrorMessage("Passwords must be greater than 3 characters.");
            return false;
        }
            ...
            {!token && (
                <div className="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                    <form action="" method="post" className="form-box">
                        ...
                        <div className="form-group">
                  <p className="text-black">Already have an account? <Link to="#" onClick={(e) =>{e.stopPropagation(); setSignIn(true)}}>Sign In</Link></p>
