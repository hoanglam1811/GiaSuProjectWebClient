...
import { DeletePost, GetAllPost, GetPost, GetPostById, Refund, UpdateApprovePost, UpdatePost } from "../../services/ApiServices/PostService";
...
export function ModeratorTutorPost() {
    ...
    const approvePost = async (post) => {
        try {
            ...
            await UpdateApprovePost(formData);
            await fetchPosts();
