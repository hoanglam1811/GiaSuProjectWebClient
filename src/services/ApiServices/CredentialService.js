...
export async function GetAllCredentials() {
    const response = await axios.get(
        `${getEndpoint()}/api/Credential/GetAll`,
        ngrokSkipWarning
    );
...
export async function GetCredentialById(id) {
    const response = await axios.get(
        `${getEndpoint()}/api/Credential/Get?id=${id}`,
        ngrokSkipWarning
    );
    return response.data;
}
...
export async function UpdateCredential(credentialDTO) {
    const response = await axios.put(
        `${getEndpoint()}/api/Credential/Update`,
        credentialDTO,
        ngrokSkipWarning
    );
    return response.data;
...
export async function UpdateApproveCredential(credentialDTO) {
    const response = await axios.put(
        `${getEndpoint()}/api/Credential/UpdateApprove`,
        credentialDTO,
        ngrokSkipWarning
    );
    return response.data;
...
export async function UploadCredentialImage(formData) {
    const response = await axios.post(
        `${getEndpoint()}/api/Credential/UploadImage`,
        formData,
        {
            headers: {
